...
//     // Ask if they want to make it a $15 Premium Template or $0 Free
//     let setPrice = 0;
//     let setIsPaid = false;

//     if (targetShareState) {
//       const askPaid = confirm("Would you like to list this as a Premium Template ($15)? Click OK for $15 Premium, or Cancel for $0 Free.");
//       if (askPaid) {
//         setPrice = 15;
//         setIsPaid = true;
//       }
...
//     setProject({ ...project, isPublic: targetShareState, isPaid: setIsPaid, price: setPrice });

//     try {
//       await api.patch(`/projects/${projectId}/share`, { 
//         isPublic: targetShareState,
//         isPaid: setIsPaid,
//         price: setPrice
//       });
//       setToast({
...
//           ? `Project published to Marketplace as ${setIsPaid ? '$15 Premium' : 'Free'} Blueprint!` 
   ...
   const executePublish = async (publishData: {
    ...
    try {
      ...
      setDialog({
        ...
        message: 'Sparksy was unable to list your product. Please try again.',
      });
    }
  };
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-stone-200 dark:border-stone-800/60 pb-6">
          ...
          >
            {project.isPublic ? (
              <>
                <Globe className="w-4 h-4 text-emerald-500 animate-pulse-subtle" />
                Shared Publicly {project.isPaid && `($${project.price})`}
              </>
            ) : (
              <>
                <GlobeLock className="w-4 h-4 text-stone-400 dark:text-stone-500" />
